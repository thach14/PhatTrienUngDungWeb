...
echo "Số thứ nhất:".$_SESSION['so_thu_nhat']."<br>";
echo "Số thứ hai: ".$_SESSION["so_thu_hai"]."<br>";
echo "Phép tính: ".$_SESSION['phep_tinh']."<br>";
$pheptinh = $_SESSION['phep_tinh'];
if($pheptinh=="cong")
{
	echo $_SESSION['so_thu_nhat']." + ".$_SESSION['so_thu_hai']. " = " . $_SESSION['so_thu_nhat']+$_SESSION['so_thu_hai'];
}
if($pheptinh=="tru")
{
	echo $_SESSION['so_thu_nhat']." - ".$_SESSION['so_thu_hai']. " = " . $_SESSION['so_thu_nhat']+$_SESSION['so_thu_hai'];
...
if($pheptinh=="chia")
{
	if ($_SESSION['so_thu_hai']==0)
	{
		echo "Không thể chia cho số 0";
	}
	else echo $_SESSION['so_thu_nhat']." / ".$_SESSION['so_thu_hai']. " = " . $_SESSION['so_thu_nhat']+$_SESSION['so_thu_hai'];
}

?>
<br>
<a href="bt3-1.php">Quay lại trang trước</a>
</div>  
</body>
</html>
