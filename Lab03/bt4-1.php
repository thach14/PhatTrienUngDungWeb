...
<div class="container">
	<h2>Thuộc tính tập tin</h2>
<form action="bt4-upload.php" method="post" enctype="multipart/form-data">
    Chọn file để upload:
    <input type="file" name="fileupload" id="fileupload"> <br>
    <input type="submit" value="Thuộc tính" name="submit" class="btn btn-success">
</form>
</div> 
</body>
</html>